...
\begin{itemize}
  ...
  \item \textbf{Delivery.} Each variant publishes its own predictions file and registers in a per-source variants index; the UI's Predictions tab exposes a Model switcher and a side-by-side table of MRR, Hits@1/3/10 and backtest months (Section~\ref{sec:ui}) --- the Spring 2025 comparison-table format, instantiated with our runs.
\end{itemize}
