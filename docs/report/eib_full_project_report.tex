...
\author{IEOR 4737 --- AI Applications in Finance \\
  ...
  Fall 2025 \textbullet\ Spring 2026 \textbullet\ Summer 2026}
\date{\today}
...
\begin{itemize}
  ...
  \item \textbf{Three semesters of work.}
    \begin{itemize}
      \item Fall 2025 built the first end-to-end pipeline on the FNSPID financial news dataset.
      \item Spring 2026 hardened the pipeline: fixed a data-leakage bug in the evaluation, showed full article text beats article summary for extraction, added causal-feature augmentation that stabilised the model through Covid-19.
      \item Summer 2026 (current) added: multi-LLM benchmark (Claude, GPT, Qwen, Gemini) with automated quality scoring; a public, deployed web application; a FinDKG-style predictions leaderboard driven by real GAT weights.
    \end{itemize}
  \item \textbf{Current state.}
    \begin{itemize}
      \item Live web application at \url{https://eib-knowledge-graph.vercel.app}.
      \item 24 months of knowledge graph snapshots (2019-01 through 2020-12), \(\approx\) 12{,}000 triplets, \(\approx\) 8{,}000 entities.
      \item GAT predictions layer with MRR 0.77 on rolling-window link prediction.
...
\subsection{Fall 2025 --- Baseline pipeline}
...
\begin{itemize}
  ...
  \item Delivered an initial static HTML visualisation of monthly knowledge graphs.
\end{itemize}
...
\bibitem{fall2025}
Lee, G., Gao, J., Lu, X., \& Cuadros, A.\ (Fall 2025). \emph{LLM and Graphs for Financial Texts} (baseline pipeline report).
